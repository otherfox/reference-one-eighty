...
/**
 * Upgrade the database to version 1903.
 *
 * @since 1.9.0
 *
 * @uses _genesis_update_settings()
 */
function genesis_upgrade_1903() {
...
function genesis_upgrade() {
	...
	###########################
	# UPDATE DB TO VERSION 1903
	###########################

	if ( genesis_get_option( 'db_version', null, false ) < '1903' )
		genesis_upgrade_1903();
