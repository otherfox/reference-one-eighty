...
if( !class_exists( 'DigLabs_Stripe_Webhook_Legacy_Processor' ) )
{
    class DigLabs_Stripe_Webhook_Legacy_Processor implements DigLabs_Stripe_Webhook_Processor_Interface
    {
